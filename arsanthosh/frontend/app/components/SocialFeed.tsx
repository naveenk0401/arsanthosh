export default function SocialFeed() {
    const posts = [
        ...
        "https://images.unsplash.com/photo-1617806118233-f8e1374bd7fb?q=80&w=400&auto=format&fit=crop"
    ];
        ...
        <section className="py-16 md:py-24 bg-white border-t border-gray-50">
            <div className="max-w-7xl mx-auto px-6">
                <div className="flex flex-col md:flex-row justify-between items-center mb-12 gap-6 text-center md:text-left">
                    ...
                    <button className="bg-black text-white px-8 py-3 text-[10px] font-bold uppercase tracking-widest hover:bg-[var(--accent)] transition-colors rounded-sm shadow-lg">
                        Follow on Instagram
                    </button>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
                    {posts.map((img, i) => (
                        <div key={i} className="aspect-square relative group overflow-hidden bg-gray-100 rounded-sm">
                            <img
                                src={img}
                                alt="Instagram Post"

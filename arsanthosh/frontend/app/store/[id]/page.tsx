                        ...
                        <div className="mt-auto space-y-6">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <button
                                    ...
                                    className="flex-1 bg-white border-2 border-black text-black py-4 font-bold uppercase tracking-widest text-xs hover:bg-black hover:text-white transition-all shadow-lg"
                                >
                                    Add to Cart
                                </button>
                                <button

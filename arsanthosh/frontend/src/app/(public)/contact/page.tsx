...
export default function ContactPage() {
    ...
    const phoneNumber = "9843237459"; // Updated phone number
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // Map frontend service choice to backend enum if possible, or "Other"
        // Backend Enum: ["Architectural Design", "Interior Design", "Consultation", "Construction", "Other"]
        ...
        // Prepend service details to message for clarity in admin/email
    ...
    return (
        <main className="min-h-screen bg-[var(--bg)]">
                            ...
                            <div className="space-y-8">
                                <div className="flex items-start gap-6">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-bold text-gray-900">contact@arsanthosh.com</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-6">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-bold text-gray-900">+91 9843237459</p>
                                    </div>
                                </div>
                        ...
                        <div className="bg-white p-8 md:p-12 shadow-2xl border border-gray-100 rounded-sm">
                            {status === "success" ? (
                                <div className="text-center py-12">
                                    ...
                                    <h3 className="text-xl font-bold font-display mb-3">Message Sent!</h3>
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    {status === "error" && (
                                        <div className="p-3 bg-red-50 text-red-600 text-xs border border-red-100 rounded-sm">
                                            {errorMessage}
                                        </div>
                                    )}
                                    ...
                                    <button
                                        ...
                                        className="w-full bg-[var(--primary)] text-white py-5 font-bold hover:bg-black transition-all uppercase tracking-widest text-xs shadow-lg flex items-center justify-center gap-3 group disabled:opacity-70 disabled:cursor-not-allowed"
                                    >
                                        {status === "loading" ? (
                                            <>
            ...
            {/* Floating WhatsApp Button (Kept as alternative, but form is primary) */}
            <a
